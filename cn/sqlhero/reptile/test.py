...
#
# #开启chrome浏览无头模式自动化工具
# driver = webdriver.Chrome(chrome_options=chrome_options,executable_path=r'F:/chromedriver.exe')
# driver.get(url)
# print(driver.get_cookies())
#
# #保存cookies
...
#
# driver2 = webdriver.Chrome(chrome_options=chrome_options,executable_path=r'F:/chromedriver.exe')
# driver2.get(url)
